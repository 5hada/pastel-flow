# Renderer UI Agent Guide

This document apply to all files and directories under `src/renderer`.
...
- left: app icon, title, current page
- right: page control button group, refresh button
...
- Tools: tools hierarchy view, using selected tool
- Setting: setting categories, settings of selected category