...
export function isSettingsDirty(form: AppSettings, settings: AppSettings): boolean {
  return (
    ...
    form.workflowListDisplayMode !== settings.workflowListDisplayMode ||
    form.workflowGridColumnCount !== settings.workflowGridColumnCount ||
    form.startAtLogin !== settings.startAtLogin ||
    form.workflowRunEventRetentionLimit !==
      settings.workflowRunEventRetentionLimit ||
    form.workflowRunEventExportLimit !== settings.workflowRunEventExportLimit ||
